<?php
	...
	*/
	...
	# -------------------------------------------------------------------------------------------------------------------
	# (class) mgHTMLDOMNode, represents a HTML DOM Node
	class mgHTMLDOMNode {
	...
	# -------------------------------------------------------------------------------------------------------------------
	# (class) mgHTMLDOM, the HTML DOM Parser
	class mgHTMLDOM {
		public $root = null;
		public $nodes = array();
		...
		protected function prepare($str, $lowercase=true) {
			...
			$this->root = new mgHTMLDOMNode($this);
			$this->root->tag = 'root';
